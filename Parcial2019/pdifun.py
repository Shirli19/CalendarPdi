...
def filtroNotchAd_Hoc(rows, cols, cortes, order, pasa=0):
    #valores del santo Franco Maztkin cortes = [.04, .043], orden = 100
    #cortes = [.04, .043]
    #orden = 100
    # Para el ejercicio de ruido del tp
    # Corte es una tupla o lista
